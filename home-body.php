    ...
    <div class="body-container">
        <div class="professionals-container">
            ...
            <ul>
                ...
                <li>
                    <div class="worker-entry" data-lat="41.9050" data-id="2" data-lng="12.5000" data-name="Gianna Limone" data-category="Colf" data-rating="4.5">

                        <div class="img-infos-container">


                            <img src="img/professionals/gianna-limone.jpeg" alt="gianna-limone">
                            <div class="infos-container">
                                <div class="worker-info">
                                    <span class="worker-name">Gianna Limone</span>
                                    <span class="worker-category">Colf</span>
                        ...
                        <div class="worker-menu hidden">
                            <div class="worker-menu-infos">
                            ...
                            <button class="worker-menu-button">Contatta</button>
                        </div>
                    </div>
                </li>
